...
## Видео и материалы для новичков

Видео, ссылки Rutube и карточки материалов редактируются через Pages CMS. Загруженные видео хранятся в `assets/videos`, документы — в `assets/materials`.
...
Файл `content/site.json` — единый источник для объявления, расписания, контактов, цен, новостей, фотографий, видео и материалов. Для редактирования без кода подключён Pages CMS через `.pages.yml`.
...
Проверка данных CMS и локальных ссылок:
